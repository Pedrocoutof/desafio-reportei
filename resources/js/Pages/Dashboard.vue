...
let {loadingRepositories, loadingSelectedRepository, loadingCommitData} = ref(false);
const {props} = usePage();
...
async function generateInsights() {
    loadingCommitData = !loadingCommitData;
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <form class="max-w">
                            ...
                            <div class="flex items-center">
                                ...
                                <select v-model="selectedRepository" :disabled="loadingRepositories" id="countries" class="flex-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-r-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
