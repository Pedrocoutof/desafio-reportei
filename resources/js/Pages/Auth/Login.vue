...
<template>
    ...
    <GuestLayout>
        ...
        <h2 class="dark:text-gray-400 text-gray-600 p-6 text-center">
            Gere métricas automatizadas dos seus repositórios!
        </h2>

        <form :action="route('github.login')" class="text-center">
